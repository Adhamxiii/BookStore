...
const defaultSections: SectionData[] = [
  {
    text: "Shop our Products with Best Price",
    img: "https://images.pexels.com/photos/1370295/pexels-photo-1370295.jpeg",
  },
  {
    text: "History, Science, Kids, and more",
    img: "https://images.pexels.com/photos/694740/pexels-photo-694740.jpeg",
  },
  {
    text: "Discount Up To 40%",
    img: "https://images.pexels.com/photos/775998/pexels-photo-775998.jpeg",
  },
];
...
const Hero = ({
  ...
  useGSAP(
    ...
    {
      scope: containerRef,
      dependencies: [sections.length, imagesLoaded, isHeroInView],
    }
  );
      ...
      >
        <div className="pointer-events-none absolute bottom-8 left-1/2 z-40 -translate-x-1/2">
          <Button
            ...
            className="pointer-events-auto bg-[#F86D72] hover:bg-[#dd6165] text-white px-6 py-2 rounded-full shadow-lg"
          >
            Explore Highlights
          </Button>
        </div>
